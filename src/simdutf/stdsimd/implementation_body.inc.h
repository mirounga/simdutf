// Re-includable class declaration body for ONE stdsimd tier. The includer
// (implementation.h) sets SIMDUTF_STDSIMD_BODY_NS / _NAME / _ISA before each
// inclusion. This file is intentionally NOT guarded so it can be pulled three
// times (once per tier namespace) to declare all three implementation classes.
namespace simdutf {
namespace SIMDUTF_STDSIMD_BODY_NS {
...
public:
  simdutf_really_inline implementation()
      : simdutf::implementation(SIMDUTF_STDSIMD_BODY_NAME,
                                "C++26 std::simd backend",
                                SIMDUTF_STDSIMD_BODY_ISA) {}
