#ifndef SIMDUTF_STDSIMD_BITMANIPULATION_H
#define SIMDUTF_STDSIMD_BITMANIPULATION_H

// These helpers are scalar and identical to the haswell shapes; they are reused
// as-is by the generic algorithm headers.
...
#endif // SIMDUTF_STDSIMD_BITMANIPULATION_H
